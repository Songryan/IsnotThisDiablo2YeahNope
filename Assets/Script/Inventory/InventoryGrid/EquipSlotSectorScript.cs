...
public class EquipSlotSectorScript : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler // SlotSectorScript 클래스 정의, MonoBehaviour와 인터페이스를 상속
{
    ...
    public static EquipSlotSectorScript equipSlotSectorScript; // 현재 섹터 스크립트를 저장할 정적 변수
    ...
    {
        equipSlotSectorScript = this; // 현재 섹터 스크립트를 설정
    ...
    {
        equipSlotSectorScript = null; // 현재 섹터 스크립트를 초기화
