...
public class ItemDatabase : MonoBehaviour
{
    ...
    public List<int> GlobalIDList = new List<int>(); // 글로벌 ID 리스트
    public List<string> TypeNameList = new List<string>(); // 타입 이름 리스트
    public List<IntVector2> SizeList = new List<IntVector2>(); // 크기 리스트
    public List<Sprite> IconList = new List<Sprite>(); // 아이콘 리스트
